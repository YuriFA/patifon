...
Follows up on [ADR-0001](../adr/0001-preact-signals-for-ui.md): we adopted
...
closed the Preact-support request as _not planned_, and the compat layer keeps drifting
...
_Versions and status quoted as of 2026-09-09; check the linked sources before
acting — maintenance statuses especially can change quickly (Shoelace and MWC both
changed posture within the last two years)._
