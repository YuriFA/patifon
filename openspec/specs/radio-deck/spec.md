# radio-deck Specification

## Purpose

The radio deck: a vintage tabletop receiver (DOM/CSS) that owns the
visualization area while a radio station is engaged - dial, station screen,
volume knob and state visuals - replacing the area tabs and the visualizer
chrome for the duration of the engagement.
